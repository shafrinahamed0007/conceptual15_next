...
const AppDetail = async ({ params }) => {
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="mt-10 rounded-2xl border border-base-300 bg-base-100 p-6 shadow-lg md:p-8">
        <h2 className="text-xl font-bold">Rating breakdown</h2>
        <div mt-6 space-y-4>
          {appDetail.ratings.map((rating) => {
            ...
            return (
              ...
              >
                ...
                <div className="h-3 overflow-hidden rounded-full bg-base-200">
                  ...
                  <span className="text-rigth font-semibold">
